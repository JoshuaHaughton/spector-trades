  ...
  return (
    ...
    >
      <Box sx={{ textAlign: "center" }}>
        <h2>
          Learn to trade without <span className={classes.label}>breaking the bank!</span>
        </h2>
      </Box>
      ...
      >
        ...
        <Grid container spacing={5} sx={{ display: "flex", justifyContent: "center" }}>
          ...
          <Box sx={{ width: "50%" }}>
            <img src="/static/images/Features-Image.svg" width="100%" maxWidth="50vw" />
          </Box>
        </Grid>
      </Container>
    </Box>
